...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $command = "$venv_python /var/www/html/Python/bone.py $Name $x1 $y1 $x2 $y2 $height $width $evaluatorName $assessmentCount $Threshold $selectedAssessment $Scale $user $caseButton 2>&1";
